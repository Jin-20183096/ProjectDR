...
public class StatusScreen : MonoBehaviour, IPointerClickHandler
{
    ...
    [SerializeField]
    private Image[] _diceSide_STR;              //힘 주사위 스탯
    [SerializeField]
    private TextMeshProUGUI _txt_reroll_INT;    //지능 재굴림
    [SerializeField]
    private Image[] _diceSide_INT;              //지능 주사위 스탯
    [SerializeField]
    private TextMeshProUGUI _txt_reroll_DEX;    //손재주 재굴림
    [SerializeField]
    private Image[] _diceSide_DEX;              //손재주 주사위 스탯
    [SerializeField]
    private TextMeshProUGUI _txt_reroll_AGI;    //민첩 재굴림
    [SerializeField]
    private Image[] _diceSide_AGI;              //민첩 주사위 스탯
    [SerializeField]
    private TextMeshProUGUI _txt_reroll_CON;    //건강 재굴림
    [SerializeField]
    private Image[] _diceSide_CON;              //건강 주사위 스탯
    [SerializeField]
    private TextMeshProUGUI _txt_reroll_WIL;    //의지 재굴림
    [SerializeField]
    private Image[] _diceSide_WIL;              //의지 주사위 스탯
